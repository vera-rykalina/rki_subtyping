...
## Stanford (HIV Drug Resistance Database by Stanfrod University)

- [https://hivdb.stanford.edu/hivdb/by-sequences/](https://hivdb.stanford.edu/hivdb/by-sequences/)

## Comet (COntext-based Modeling for Expeditious Typing by LIH)

- [https://comet.lih.lu/](https://comet.lih.lu/)

## Rega (Rega HIV Subtyping Tool by  Genome Detective)
