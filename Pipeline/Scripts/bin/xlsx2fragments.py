...
def create_excels(args):
    ...
    all_scounts = prrt_scounts + int_scounts

    # Remove duplicates from the master list of scounts
    scounts = list(set(all_scounts))

    # Look up for scount in scounts, if it is not present in PRRT, INT: add tag notSequenced and empty string for "Sequenz" column
