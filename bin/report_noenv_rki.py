...
def merge_dfs(prrt, int):
    try:
        ...
        merged_dfs.rename(columns = {"Scount":"SCount", 
                                    ...
                                    "INT_Subtype": "Subtyp_INT"}, inplace = True)
...
def hivtype_report(merged_dfs):
    ...
    report["Subtyp_ENV"] = "_nichtSequenziert"
    ...
    # Replacements
    report[["Subtyp_PRRT", "Subtyp_INT"]] = report[["Subtyp_PRRT", "Subtyp_INT"]].replace(r"^_notSequenced$", r"_zu wenig PCR-Produkt", regex=True)
    report[["Subtyp_PRRT", "Subtyp_INT"]] = report[["Subtyp_PRRT", "Subtyp_INT"]].replace(r"^_SeqNichtAuswertbar$", r"_Seq. nicht auswertbar", regex=True)
    report[["Subtyp_PRRT", "Subtyp_INT"]] = report[["Subtyp_PRRT", "Subtyp_INT"]].replace(r"^_nichtSequenziert$", r"_zu wenig PCR-Produkt", regex=True)
